...
#### Historical Returns
20-year comparison of simple returns.
#### Volatily Analysis 
* Pearson correlation analysis
* Volatility, measured by standard deviation 
* GARCH volatilty modeling
...
Key leverage and liquiity indicators: 
* Net debt/EBITDA
* Total debt/EV
...
* Japan exhibits slightly lower volatilty than the US, wit a standard deviation of 0.
